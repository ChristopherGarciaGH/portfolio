...
namespace TCPData
{
    public static class Data
    {
        ...
        public static ArrayList GetColeccionDatosHeterogenea()
        {
            ArrayList arrayList = new ArrayList
            {
                ...
                3000,
                "Bill Henderson",
                new Employee(6,"Jennifer","Dale",90000,true,1),
                new Employee(7,"Dane","Hughes",60000,false,2),
                new Deparment(4,"MKT","Marketing"),
                new Deparment(5,"R&D","Research and Developent"),
                new Deparment(6,"PRD","Production")
